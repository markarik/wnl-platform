 ...
 * Generated for Laravel 5.7.27 on 2019-03-15 11:25:53.
 *
...
namespace Bschmitt\Amqp\Facades { 
    ...
    class Amqp {
         ...
         * @static 
         */ 
        public static function publish($routing, $message, $properties = array())
        {
            return \Bschmitt\Amqp\Amqp::publish($routing, $message, $properties);
        }
         ...
         * @static 
         */ 
        public static function consume($queue, $callback, $properties = array())
        {
            return \Bschmitt\Amqp\Amqp::consume($queue, $callback, $properties);
        }
         ...
         * @static 
         */ 
        public static function message($body, $properties = array())
        {
            return \Bschmitt\Amqp\Amqp::message($body, $properties);
        }
...
namespace  { 
    ...
    class Rabbit extends \Bschmitt\Amqp\Facades\Amqp {}

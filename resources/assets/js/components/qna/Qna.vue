...
<script>
	...
	export default {
		...
		props: ['tags', 'readOnly', 'title', 'icon', 'reactionsDisabled', 'qnaAnswersCompetency', 'qnaQuestionsCompetency', 'sortingEnabled', 'numbersDisabled', 'colorHeaderOpacity', 'colorHeader', 'showContext'],
		data() {
			return {
				ready: false,
				showForm: false,

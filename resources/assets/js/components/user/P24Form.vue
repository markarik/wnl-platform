<template>
	<form method="post" :action="paymentData.transaction_url" v-if="!isEmpty(userData) && !isEmpty(paymentData)">
		...
		<input type="hidden" name="p24_email" :value="paymentData.user_email"/>

export const questions = {
	...
	solving: {
		...
		confirm: {
			...
			satisfactionGuaranteeWarning: '⚠️ Odpowiedz na wszystkie pytania, aby próbny egzamin został uznany za ukończony (warunek przyznania Gwarancji Satysfakcji).',
			continueLater: 'Jeżeli musisz teraz przerwać, możesz później rozwiązać egzamin od nowa.',
			yes: 'Chcę dokończyć',
		},

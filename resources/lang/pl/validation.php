...
return [
	...
	"confirmed"            => "Niestety, :attribute nie zgadza się z potwierdzeniem.",
	...
	"required_if"          => ":attribute jest polem wymaganym, gdy :other ma wartość :value.",
	"required_with"        => ":attribute jest polem wymaganym, gdy :values są zdefiniowane.",
	"required_with_all"    => ":attribute jest polem wymaganym, gdy :values są zdefiniowane.",
	"required_without"     => ":attribute jest polem wymaganym, gdy :values nie są zdefiniowane.",
	"required_without_all" => ":attribute jest polem wymaganym, gdy żadne z :values nie są zdefiniowane.",

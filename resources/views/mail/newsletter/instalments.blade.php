...
@section('content')
	...
	<p class="has-text-centered"><strong>Chcemy Wam przede wszystkim bardzo podziękować za zaufanie i wsparcie! Ponad 100 z Was zadeklarowało już udział w kursie! Dostajemy też wiele doskonałych sugestii oraz pytań, które pozwalają nam lepiej dopasować “Więcej niż LEK” do Waszych potrzeb. Dziękujemy!</strong></p>

	<p>Dziś mamy dla Was dwa krótkie, lecz ważne ogłoszenia. :)</p>

	<h3>W czwartek od 19:00 do 21:00 odpowiadamy na Wasze pytania!</h3>
	<p>Zdajemy sobie sprawę, że na stronie jest co czytać o kursie. :) Wciąż jednak mamy Wam bardzo wiele do powiedzenia! Tym razem jednak, postawiliśmy na bardziej interaktywną formę przekazu.</p>
	<p>Dlatego serdecznie zapraszamy Was do wzięcia udziału w streamingu, podczas którego będziemy odpowiadać na wszystkie Wasze pytania. Na pewno dokładnie opowiemy o warsztatach z naszymi wyjątkowymi gośćmi, metodologii nauczania oraz o tym, jak wyobrażamy sobie codzienną interakcję z platformą e-learningową.</p>
	<p>Nie zabraknie też rozważań o naszych dalszych planach oraz misji "Więcej niż LEK". :)</p>
	<div style="text-align: center; margin: 10px auto 20px;">
		<a class="button" href="https://www.facebook.com/events/1818711421723449/">

...
@section('content')
	...
	<p><strong>Na wstępie chcielibyśmy gorąco podziękować Ci za zaufanie i dołączenie do kursu “Więcej niż LEK”! Nie możemy już doczekać się wspólnej nauki! I mamy nadzieję, że Ty również. ;)</strong></p>

	<p>W związku z nadchodzącym startem kursu chcielibyśmy przybliżyć Ci co wydarzy się w najbliższych dniach. :)</p>
...
<hr style="border: 0; height: 1px; background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">
	...
	<h4>6 listopada</h4>
	<p>Ruszamy z programem kursu! Na pierwszy ogień - Kardiologia, której poświęcimy cały pierwszy tydzień! :) W razie pytań i wątpliwości, przez pierwsze dni będziemy dla Ciebie dostępni niemal całodobowo. ;) Wiemy, że pierwsze kroki w nowym środowisku mogą być jeszcze niepewne, dlatego postaramy się zapewnić Ci maksimum wsparcia!</p>

<hr style="border: 0; height: 1px; background-image: linear-gradient(to right, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0));">

	<p>Pozostajemy do Twojej dyspozycji na <a href="https://facebook.com/wiecejnizlek">facebooku</a> oraz na info@wiecejnizlek.pl! Przygodę czas zacząć! :)</p>

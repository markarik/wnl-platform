...
@section('content')
	...
	<p>Cena Twojego zamówienia oraz wysokości przyszłych wpłat zostały odpowiednio obniżone. :)</p>

	<p>Więcej informacji znajdziesz w zakładce <a href="{{url('app/myself/orders')}}" target="_blank">Konto > Twoje zamówienia</a>. :)</p>

				 ...
				 <section class="has-text-centered">
					<div class="expandable">
						...
						<div class="expandable-content box">
							...
							<p class="margin bottom">Możesz zapłacić w trzech ratach - pierwszej <strong>7 dni po złożeniu zamówienia, ale nie później niż do 15 maja</strong> i kolejnych do <strong>15 czerwca</strong> i <strong>15 lipca</strong>.</p>

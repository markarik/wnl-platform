<p>Dziękujemy za odwiedzenie strony naszego serwisu internetowego udostępnianego pod adresem internetowym <a href="https://wiecejnizlek.pl">https://wiecejnizlek.pl</a> (dalej jako: „WiecejNizLek”, „Serwis Internetowy” lub „Serwis”).</p>

<p>Formuła niniejszego regulaminu zakłada ustalenie ogólnych zasad i warunków korzystania z Serwisu Internetowego. Niniejsze warunki, w razie podjęcia decyzji przez usługobiorcę o korzystaniu z WiecejNizLek, regulują w szczególności zasady korzystania z Serwisu Internetowego, w tym kwestie naszej odpowiedzialności.</p>
<p>Zapraszamy do zapoznania się regulaminem,</p>
<p class="big strong">Zespół "Więcej niż LEK"</p>
...
<h2>2) DEFINICJE</h2>
<ol>
	<li>Definicje użyte w niniejszym Regulaminie oznaczają:
		<ol class="lower-alpha">
			<li>CENNIK – cennik wariantów Kursu Internetowego dostępny na stronie Serwisu Internetowego.</li>
			<li>DOKUMENTACJA – opis funkcjonalny funkcjonalności, działania i elementów Kursu Internetowego dostępny na stronie Serwisu Internetowego.</li>
			<li>KURS INTERNETOWY – Usługa Elektroniczna, internetowy kurs przygotowujący do Lekarskiego Egzaminu Końcowego świadczony na warunkach wskazanych szczegółowo w Regulaminie Serwisu, Cenniku oraz Dokumentacji. Kurs Internetowy może być także połączony z elementami niebędącymi Usługą Elektroniczną, np. drukowanymi materiałami szkoleniowymi lub warsztatami stacjonarnymi – w zależności od wybranego przez Usługobiorcę wariantu wskazanego w Cenniku.</li>
			<li>KODEKS CYWILNY – ustawa kodeks cywilny z dnia 23 kwietnia 1964 r. (Dz. U. Nr 16, poz. 93 ze zm.).</li>
			<li>KONTO USŁUGOBIORCY, PANEL USŁUGOBIORCY – Usługa Elektroniczna, elektroniczne konto w Serwisie Internetowym umożliwiające dostęp Usługobiorcy do Kursu Internetowego, korzystanie z niego w zakresie i zgodnie z Dokumentacją oraz zarządzanie nim. Elektroniczne konto jest częścią Serwisu Internetowego i stanowi oznaczony indywidualnym adresem poczty elektronicznej (adres email) i hasłem zbiór zasobów i funkcjonalności dostępnych w systemie teleinformatycznym Usługodawcy, w którym gromadzone są dane podane przez Usługobiorcę oraz informacje o jego działaniach w Serwisie Internetowym z wykorzystaniem jego funkcjonalności. Szczegółowy opis funkcjonalności, możliwości oraz zasad działania i usług dostępnych w ramach Konta wskazany jest w Dokumentacji.</li>
			<li>LEKARSKI EGZAMIN KOŃCOWY – Lekarski Egzamin Końcowy w rozumieniu ustawy o zawodach lekarza i lekarza dentysty z dnia 5 grudnia 1996 r. (tj. z dnia 16 grudnia 2016 r. , Dz.U. z 2017 r. poz. 125 z późn. zmianami).</li>
			<li>NEWSLETTER – Usługa Elektroniczna, elektroniczna usługa dystrybucyjna świadczona przez Usługodawcę za pośrednictwem poczty elektronicznej e-mail, która umożliwia wszystkim korzystającym z niej Usługobiorcom automatyczne otrzymywanie od Usługodawcy cyklicznych treści kolejnych edycji newslettera zawierającego informacje o nowościach i aktualnościach dotyczących Serwisu Internetowego oraz Usług Elektronicznych.</li>
			<li>PRAWO AUTORSKIE – ustawa o prawie autorskim i prawach pokrewnych z dnia 4 lutego 1994 r. (Dz. U. Nr 24, poz. 83 ze zm.)</li>
			<li>REGULAMIN – niniejszy regulamin korzystania z Serwisu Internetowego.</li>
			<li>SERWIS INTERNETOWY, SERWIS, WIECEJNIZLEK – serwis internetowy Usługodawcy dostępny pod adresem internetowym http://wiecejnizlek.pl oraz jego subdomenami.</li>
			<li>USŁUGA ELEKTRONICZNA – usługa świadczona drogą elektroniczną przez Usługodawcę na rzecz Usługobiorcy za pośrednictwem Serwisu Internetowego zgodnie z Regulaminem.</li>
			...
			<li>USŁUGODAWCA – BETHINK SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ z siedzibą w Poznaniu (adres siedziby i adres do doręczeń: ul. Henryka Sienkiewicza 8/1, 60-817 Poznań); wpisana do Rejestru Przedsiębiorców Krajowego Rejestru Sądowego pod numerem KRS 0000668811; sąd rejestrowy, w którym przechowywana jest dokumentacja spółki: Sąd Rejonowy Poznań – Nowe Miasto i Wilda w Poznaniu, VIII Wydział Gospodarczy Krajowego Rejestru Sądowego; kapitał zakładowy w wysokości: 30.000,00 zł.; NIP: 7811943756; REGON: 366802351; adres poczty elektronicznej: info@wiecejnizlek.pl.</li>
			<li>USTAWA O PRAWACH KONSUMENTA, USTAWA – ustawa z dnia 30 maja 2014 r. o prawach konsumenta (Dz.U. 2014 poz. 827 ze zm.).</li>
		</ol>
	</li>
</ol>
<h2>3) OGÓLNE WARUNKI KORZYSTANIA Z SERWISU INTERNETOWEGO</h2>
<ol>
	<li>Usługobiorca obowiązany jest do korzystania z WiecejNizLek, w tym z Kursu Internetowego i innych Usług Elektronicznych w sposób zgodny z ich przeznaczeniem, Dokumentacją, niniejszym Regulaminem oraz w sposób zgodny z prawem i dobrymi obyczajami mając na uwadze poszanowanie dóbr osobistych, danych osobowych oraz praw autorskich i własności intelektualnej Usługodawcy, innych Usługobiorców oraz osób trzecich. Usługobiorcę obowiązuje zakaz dostarczania treści o charakterze bezprawnym.</li>
	<li>Wymagania techniczne niezbędne do korzystania z WiecejNizLek, w tym z Kursu Internetowego i innych Usług Elektronicznych: (1) komputer, laptop, tablet, smartfon lub inne urządzenie multimedialne z dostępem do Internetu; (2) dostęp do poczty elektronicznej; (3) przeglądarka internetowa: Mozilla Firefox w wersji 54.0 i wyższej (stabilnej), Google Chrome w wersji 59.0. i wyższej (stabilnej); Safari w wersji 10.1 i wyższej (stabilnej); System iOS w wersji 10.3 i wyższej (stabilnej); (4) włączenie w przeglądarce internetowej możliwości zapisu plików Cookies oraz obsługi Javascript; (5) minimalna rozdzielczość ekranu 1280x1040 px.</li>
</ol>
<h2>4) USŁUGI ELEKTRONICZNE DOSTĘPNE W SERWISIE</h2>
<ol>
	...
	<li>Usługobiorca może korzystać w Serwisie Internetowym z następujących Usług Elektronicznych:</li>
		<ol class="lower-alpha">
			<li>Konto (Panel);</li>
			<li>Kurs Internetowy;</li>
			<li>Newsletter;</li>
		</ol>
	<li>Usługodawca obowiązany jest świadczyć Usługi Elektroniczne bez wad.</li>
	<li>Szczegółowy opis Usług Elektronicznych i zasad ich działania dostępny jest w Regulaminie oraz w Dokumentacji na stronie Serwisu Internetowego.</li>
</ol>
...
<h2>9) KONTAKT Z USŁUGODAWCĄ</h2>
<p>Zasadniczą formą bieżącej komunikacji na odległość z Usługobiorcami jest poczta elektroniczna (info@wiecejnizlek.pl) oraz poczta tradycyjna (ul. Henryka Sienkiewicza 8/1, 60-817 Poznań), za pośrednictwem których Usługobiorca wymieniać z nami informacje dotyczące korzystania z WiecejNizLek. Usługobiorcy mogą kontaktować się z nami także na inne dopuszczalne prawem sposoby.</p>
<h2>10)	REKLAMACJE DOTYCZĄCE SERWISU INTERNETOWEGO</h2>
<ol>
	<li>Reklamacje związane z działaniem Serwisu Internetowego, w tym Usług Elektronicznych, Usługobiorca może złożyć na przykład drogą poczty elektronicznej (mailowo) na adres: info@wiecejnizlek.pl lub pisemnie na adres: ul. Henryka Sienkiewicza 8/1, 60-817 Poznań lub za pomocą formularza kontaktowego.</li>
	...
	<li>Usługodawca ustosunkuje się do reklamacji niezwłocznie, nie później niż w terminie 14 dni kalendarzowych od dnia jej złożenia.</li>
</ol>
<h2>11) ODSTĄPIENIE OD UMOWY</h2>
<ol>
	<li>Niniejszy punkt Regulaminu ma zastosowanie jedynie do Usługobiorców będących konsumentami i dotyczy umów zawieranych między nimi, a Usługodawcą.</li>
	...
	<li>Z zastrzeżeniem pkt. 11 ust. 2 Regulaminu konsument, który zawarł umowę na odległość, może w terminie 14 dni kalendarzowych odstąpić od niej bez podawania przyczyny i bez ponoszenia kosztów, z zastrzeżeniem pkt. 11 ust. 4 Regulaminu.</li>
	<li>Jeżeli konsument wykonuje prawo odstąpienia od umowy o świadczenie usługi trwającej powyżej 14 dni oraz po zgłoszeniu żądania rozpoczęcia świadczenia usługi przed upływem terminu do odstąpienia od umowy o jej świadczenie, to ma obowiązek zapłaty za świadczenia spełnione do chwili odstąpienia od umowy. Kwotę zapłaty oblicza się proporcjonalnie do zakresu spełnionego świadczenia, z uwzględnieniem uzgodnionej w umowie ceny lub wynagrodzenia. Jeżeli cena lub wynagrodzenie są nadmierne, podstawą obliczenia tej kwoty jest wartość rynkowa spełnionego świadczenia.</li>
	<li>Do zachowania terminu na odstąpienie od umowy wystarczy wysłanie oświadczenia przed jego upływem. Oświadczenie o odstąpieniu od umowy może zostać złożone na przykład: pisemnie na adres: ul. Henryka Sienkiewicza 8/1, 60-817 Poznań lub w formie elektronicznej za pośrednictwem poczty elektronicznej na adres: info@wiecejnizlek.pl  .</li>
	<li>Bieg terminu do odstąpienia od umowy o świadczenie usługi rozpoczyna się od dnia zawarcia umowy.</li>
</ol>
<h2>12) POZASĄDOWE SPOSOBY ROZPATRYWANIA REKLAMACJI I DOCHODZENIA ROSZCZEŃ ORAZ ZASADY DOSTĘPU DO TYCH PROCEDUR</h2>
<ol>
	<li>Niniejszy punkt Regulaminu ma zastosowanie jedynie do Usługobiorców będących konsumentami.</li>
...
<ol>
	...
	<li>Usługodawca obowiązany jest informować niezwłocznie Usługobiorców o wszelkich błędach oraz awariach technicznych, o których w mowa powyżej oraz przewidywanym terminie ich usunięcia.</li>
	<li>Poza przerwami spowodowanymi błędami i awariami technicznymi mogą wystąpić także inne przerwy techniczne, w czasie których Usługodawca podejmuje działania mające na celu rozwój Serwisu Internetowego i jego Usług Elektronicznych oraz ich zabezpieczenie przed błędami i awariami technicznymi.</li>
	<li>Usługodawca obowiązany jest planować przerwy techniczne w taki sposób, aby były one jak najmniej uciążliwe dla Usługobiorców, w szczególności aby planowane były na godziny nocne i jedynie na czas niezbędny do dokonania koniecznych działań przez Usługodawcę. Usługodawca obowiązany jest informować Usługobiorców o planowanych przerwach technicznych z odpowiednim wyprzedzeniem, podając także długość trwania planowanej przerwy.</li>
	<li>Niniejszy punkt Regulaminu nie wyłącza, ani nie ogranicza uprawnień Usługobiorcy będącego konsumentem przewidzianych przepisami prawa, w szczególności w zakresie odpowiedzialności Usługodawcy.</li>
</ol>
<h2>14) PRAWA AUTORSKIE</h2>
<ol>
	<li>Prawa autorskie oraz prawa własności intelektualnej do Serwisu Internetowego jako całości oraz jego poszczególnych elementów, w tym Kursu Internetowego, treści, grafik, utworów, wzorów i znaków dostępnych w jego ramach należą do Usługodawcy lub innych uprawnionych podmiotów trzecich i objęte są ochroną Prawa Autorskiego oraz innych przepisów powszechnie obowiązującego prawa. Ochrona przyznana Serwisowi Internetowemu obejmuje wszystkie formy ich wyrażenia.</li>
	<li>Serwis Internetowy należy traktować podobnie jak każdy inny utwór podlegający ochronie autorskiej. Usługobiorca nie ma prawa kopiować Serwisu Internetowego za wyjątkiem przypadków dozwolonych przepisami bezwzględnie wiążącego prawa. Usługobiorca zobowiązuje się także nie modyfikować, adaptować, tłumaczyć, odkodowywać, dekompilować, dezasemblować lub w jakikolwiek inny sposób starać się ustalić kod źródłowy Serwisu Internetowego, za wyjątkiem przypadków dozwolonych przepisami bezwzględnie wiążącego prawa.</li>
	<li>Znaki handlowe Usługodawcy oraz podmiotów trzecich powinny być używane zgodnie z obowiązującymi przepisami prawa.</li>
</ol>
<h2>15) POSTANOWIENIA DOTYCZĄCE FIRM</h2>
<ol>
	<li>Niniejszy punkt Regulaminu ma zastosowanie jedynie do Usługobiorców niebędących konsumentami.</li>
	<li>Usługodawca ponosi odpowiedzialność w stosunku do Usługobiorcy niebędącego konsumentem, bez względu na jej podstawę prawną, jedynie do wysokości ostatnio zapłaconej opłaty na rzecz Usługodawcy, a w przypadku jej braku do wysokości 1.000,00 (jeden tysiąc) złotych. Usługodawca ponosi odpowiedzialność w stosunku do Usługobiorcy niebędącego konsumentem tylko za typowe i rzeczywiście poniesione szkody przewidywalne w momencie zawarcia umowy, z wyłączeniem utraconych korzyści.</li>
	<li>Usługodawca nie ponosi wobec Usługobiorcy niebędącego konsumentem odpowiedzialności za szkody i niewypełnienie zobowiązań wynikające z działania siły wyższej lub wszelkich innych przyczyn pozostających poza kontrolą Usługodawcy.</li>
</ol>
<h2>16) POSTANOWIENIA KOŃCOWE</h2>
<ol>
	<li>Umowy zawierane poprzez WiecejNizLek zawierane są zgodnie z prawem polskim i w języku polskim.</li>
...
<p>Dziękujemy za uważną lekturę!</p>
<p>W razie pytań jesteśmy zawsze do Państwa dyspozycji – prosimy o kontakt.</p>
<p>Zapraszamy do współpracy,</p>
<p class="big strong">Zespół "Wiecej niż LEK"</p>



<h2>17) WZÓR FORMULARZA ODSTĄPIENIA OD UMOWY (ZAŁĄCZNIK NUMER 2 DO USTAWY O PRAWACH KONSUMENTA)</h2>
...
<h4>Adresat:</h4>
<p>BETHINK SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ<br>
ul. Henryka Sienkiewicza 8/1, 60-817 Poznań<br>
info@wiecejnizlek.pl</p>

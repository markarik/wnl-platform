...
<ol>
	...
	<li>Wymagania techniczne niezbędne do korzystania z WiecejNizLek, w tym z Kursu Internetowego i innych Usług Elektronicznych: (1) komputer, laptop, tablet, smartfon lub inne urządzenie multimedialne z dostępem do Internetu; (2) dostęp do poczty elektronicznej; (3) przeglądarka internetowa: Mozilla Firefox w wersji 20.0 i wyższej (stabilnej), Google Chrome w wersji 25.0. i wyższej (stabilnej); (4) włączenie w przeglądarce internetowej możliwości zapisu plików Cookies oraz obsługi Javascript; (5) minimalna rozdzielczość ekranu 1280x1040 px.</li>
</ol>

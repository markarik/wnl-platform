...
Route::group(['namespace' => 'Api\PrivateApi', 'middleware' => 'api-auth'], function () {
	...
	Route::patch("{$r['users']}/{id}/{$r['user-notifications']}", 'User\UserNotificationApiController@patchMany');
	...
	// Quiz Questions
	Route::get("{$r['quiz-questions']}/{id}", 'Quiz\QuizQuestionsApiController@get');
